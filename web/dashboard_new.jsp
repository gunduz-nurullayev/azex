    ...
    <div class="content-wrapper">
        ...
        <div class="page-content fade-in-up">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <table class="table table-striped table-bordered table-hover" id="flexible-list-table" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Value ID</th>
                        ...
                        <tbody>
                          <%--  <%
                            ...
                            for(FlexibleListItem item : list.getItemList()) {  %>
                                <tr>
                                <td><%=item.getId()%></td>
                                <td><%=item.getValueId()%></td>
                                <td><%=item.getValueName()%></td>
                                <td><%=item.getInsertDate()%></td>
                                </tr>
                            <%
                            }
                            %>--%>
...
<script type="text/javascript">
    $(function() {
        $('#flexible-list-table').DataTable({
            "lengthMenu": [[1, 2, 3, 4, 5, 10, 25, 50, -1], [1, 2, 3, 4, 5, 10, 25, 50, "All"]],
            "serverSide":"true",
            "ajax": 'admin?action=getFlexibleListItems&id=2'
        });
    })
</script>
</body>
