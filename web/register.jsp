...
<body class="bg-silver-300">
    <div class="content">
        <div class="brand">
            <a class="link" href="login.jsp">Azex</a>
        </div>
        <form id="register-form" action="signup" method="post">
            <h2 class="login-title">Qeydiyyat</h2>

            <div class="row">
                <label style="color:red">${sessionScope.passwordCheck}</label>
<%--
                <a style="color:red">${sessionScope.userFirstAdd}</a>
--%>
                <div class="col-6">
            ...
            <div class="form-group">
                <button class="btn btn-info btn-block" type="submit">Təsdiq et</button>
            </div>
            ...
            <div class="text-center">Already a member?
                <a class="color-blue" href="login.jsp">Login here</a>
            </div>
        </form>
    </div>
