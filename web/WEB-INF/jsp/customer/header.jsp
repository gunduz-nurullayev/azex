...
<header class="header">
    <div class="page-brand">
        <a class="link" href="addresses.jsp">
                    <span class="brand">   Azex
                    </span>
        ...
        <ul class="nav navbar-toolbar">
            ...
            <li class="dropdown dropdown-user">
                <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                    ...
                    <span></span>${sessionScope.user.getRoleList().get(0).getName()}<i
                        class="fa fa-angle-down m-l-5"></i></a>
                <ul class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="profile.jsp"><i class="fa fa-user"></i>Profile</a>
                    <a class="dropdown-item" href="profile.jsp"><i class="fa fa-cog"></i>Settings</a>
                    <a class="dropdown-item" href="javascript:;"><i class="fa fa-support"></i>Support</a>
                    <li class="dropdown-divider"></li>
                    <a class="dropdown-item" href="logout.jsp"><i class="fa fa-power-off"></i>Logout</a>
                </ul>
            </li>
        </ul>
